...
uint16_t _LAYERS[LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
    {
        ...
        {LSFT_T(KC_ESC),KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLASH,   RSFT_T(KC_QUOTE),_______,  _______},
        {KC_LCTRL,      MO(1),      KC_LALT,    KC_SPC,     _______,    _______,    _______,    _______,    KC_RALT,    MO(2),      KC_LGUI,    KC_RCTRL,     _______,     _______}
    },
    {
