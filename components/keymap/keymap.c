...
uint16_t _LAYERS[LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
    {
        ...
        {KC_CAPS,       KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       KC_H,       KC_J,       KC_K,       KC_L,       KC_SCOLON,  KC_QUOTE,     KC_ENTER,    KC_PGDOWN},
        {LSFT_T(KC_ESC),KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLASH,   RSFT_T(KC_QUOTE),  KC_UP,  KC_END},
        {KC_LCTRL,      KC_LGUI,    KC_LALT,    TO(1),      KC_SPC,     KC_SPC,     TO(2),      KC_RALT,    KC_RCTRL,   KC_LEFT,    KC_DOWN,    KC_RIGHT,     KC_PGUP,     KC_HOME}
    },
    {
        {KC_GRAVE,      KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_EQUAL,   KC_DEL,    _______,    _______},
        {_______,       KC_F10,     KC_F11,     KC_F12,     _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_RBRC,    _______,    _______},
    ...
    {
        {FUNCTION_KEY_INTRO, FUNCTION_KEY_DEVICE_INFO, FUNCTION_KEY_HOTSPOT, _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_MINUS,   KC_EQUAL,    _______,    _______},
        {_______,       _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______},
        {_______,       _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______},
        {_______,       _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______},
        {_______,       _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______}
