...
struct menu_item {
    ...
    bool (*handle_input_key)(void *user_ctx, input_event_e input_event, char key_code);         // Optional input key handler function
    esp_err_t (*user_action)(void *user_ctx);   // Optional user action function
...
/**
 * @brief Get current timeout in ms
 */
