...
uint16_t _LAYERS[LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
    {
        ...
        {KC_LCTRL,      KC_LGUI,    KC_LALT,    KC_BSPC,  LT(1, KC_SPC),KC_SPC,     KC_SPC,   LT(1, KC_SPC),KC_LEFT,    KC_UP,      KC_DOWN,    KC_RIGHT}
    },
    {
        {KC_F1,         KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,     KC_EQUAL},
