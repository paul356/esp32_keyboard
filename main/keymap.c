...
uint16_t _LAYERS[LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
    {
        ...
        {KC_LCTRL,      KC_LGUI,    KC_LALT,    KC_ESC,     MO(1),      KC_SPC,     KC_SPC,   LT(1, KC_SPC),KC_SLASH,   KC_LEFT,    KC_DOWN,    KC_RIGHT}
    },
    {
        {KC_F1,         KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12},
        {_______,       _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_LBRC,    KC_RBRC,    KC_EQUAL},
        {_______,       _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_BSLASH,  KC_QUOTE},
