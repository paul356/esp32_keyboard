...
uint16_t _LAYERS[LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
    {
        ...
        {LSFT_T(KC_ESC),KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMMA,   KC_DOT,     KC_SLASH,   KC_ENTER},
        {KC_LCTRL,      KC_LGUI,    KC_LALT,    KC_COMM,    MO(1),      KC_SPACE,   KC_SPACE,   MO(2),      KC_LEFT,    KC_UP,      KC_DOWN,    KC_RIGHT}
    },
    {
        {KC_F1,         KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12},
        {_______,       _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_RBRACKET},
