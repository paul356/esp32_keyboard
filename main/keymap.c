...
uint16_t _LAYERS[LAYERS][MATRIX_ROWS][KEYMAP_COLS] = {
    {
        ...
        {KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCOLON,KC_QUOTE,KC_ENTER,KC_NONE},
        {KC_LSHIFT,KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMMA,KC_DOT,  KC_SLASH,KC_RSHIFT,KC_UP, KC_NONE},
        {KC_LCTRL,KC_LGUI, KC_LALT, KC_SPACE,KC_NONE, KC_NONE, KC_RALT, KC_NONE, KC_LCTRL,KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDOWN,KC_PGUP}
    },
    {
        {KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL},
        {KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINUS,KC_EQUAL,KC_BSPACE},
